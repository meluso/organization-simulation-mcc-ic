...
plt.subplot(1,3,1)
plt.plot(x_values,100*mcc_mean,label='Contest-Orientation')
plt.plot(x_values,100*(1-mcc_mean),label='Inclusiveness')
plt.xlabel('Turns')
...
plt.subplot(1,3,2)
plt.plot(x_values,100*lvl_mean[:,0],label='Level 1')
plt.plot(x_values,100*lvl_mean[:,1],label='Level 2')
plt.plot(x_values,100*lvl_mean[:,2],label='Level 3')
plt.plot(x_values,100*lvl_mean[:,3],label='Level 4')
plt.plot(x_values,100*lvl_mean[:,4],label='Level 5')
plt.xlabel('Turns')
