...
if plot_num == 1:
    ...
    plt.subplot(1,2,1)
    plt.plot(x_values,mcc[1,:],label='MCC=0.1',color='k',lw=1,ls=(0,()))
    plt.plot(x_values,mcc[2,:],label='MCC=0.2',color='k',lw=1,ls=(0,(5,1)))
    plt.plot(x_values,mcc[3,:],label='MCC=0.3',color='k',lw=1,ls=(0,(3,1,1,1)))
    plt.plot(x_values,mcc[4,:],label='MCC=0.4',color='k',lw=1,ls=(0,(3,1)))
    plt.plot(x_values,mcc[5,:],label='MCC=0.5',color='k',lw=1,ls=(0,(1,1)))
    plt.plot(x_values,mcc[6,:],label='MCC=0.6',color='gray',lw=1,ls=(0,()))
    plt.plot(x_values,mcc[7,:],label='MCC=0.7',color='gray',lw=1,ls=(0,(5,1)))
    plt.plot(x_values,mcc[8,:],label='MCC=0.8',color='gray',lw=1,ls=(0,(3,1,1,1)))
    plt.plot(x_values,mcc[9,:],label='MCC=0.9',color='gray',lw=1,ls=(0,(3,1)))
    plt.xlabel('Turns')
    ...
    plt.subplot(1,2,2)
    plt.plot(x_values,prf[1,:],label='MCC=0.1',color='k',lw=1,ls=(0,()))
    plt.plot(x_values,prf[2,:],label='MCC=0.2',color='k',lw=1,ls=(0,(5,1)))
    plt.plot(x_values,prf[3,:],label='MCC=0.3',color='k',lw=1,ls=(0,(3,1,1,1)))
    plt.plot(x_values,prf[4,:],label='MCC=0.4',color='k',lw=1,ls=(0,(3,1)))
    plt.plot(x_values,prf[5,:],label='MCC=0.5',color='k',lw=1,ls=(0,(1,1)))
    plt.plot(x_values,prf[6,:],label='MCC=0.6',color='gray',lw=1,ls=(0,()))
    plt.plot(x_values,prf[7,:],label='MCC=0.7',color='gray',lw=1,ls=(0,(5,1)))
    plt.plot(x_values,prf[8,:],label='MCC=0.8',color='gray',lw=1,ls=(0,(3,1,1,1)))
    plt.plot(x_values,prf[9,:],label='MCC=0.9',color='gray',lw=1,ls=(0,(3,1)))
    plt.xlabel('Turns')
